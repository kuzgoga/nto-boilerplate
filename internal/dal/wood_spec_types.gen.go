...
func newWoodSpecType(db *gorm.DB, opts ...gen.DOOption) woodSpecType {
	...
	_woodSpecType.Receivers = woodSpecTypeHasManyReceivers{
...
type woodSpecType struct {
	...
	Id        field.Uint
	Name      field.String
	Receivers woodSpecTypeHasManyReceivers
...
type woodSpecTypeHasManyReceivers struct {
	db *gorm.DB
...
func (a woodSpecTypeHasManyReceivers) Where(conds ...field.Expr) *woodSpecTypeHasManyReceivers {
	if len(conds) == 0 {
		return &a
	}
...
func (a woodSpecTypeHasManyReceivers) WithContext(ctx context.Context) *woodSpecTypeHasManyReceivers {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a woodSpecTypeHasManyReceivers) Session(session *gorm.Session) *woodSpecTypeHasManyReceivers {
	a.db = a.db.Session(session)
	return &a
}

func (a woodSpecTypeHasManyReceivers) Model(m *models.WoodSpecType) *woodSpecTypeHasManyReceiversTx {
	return &woodSpecTypeHasManyReceiversTx{a.db.Model(m).Association(a.Name())}
}

type woodSpecTypeHasManyReceiversTx struct{ tx *gorm.Association }

func (a woodSpecTypeHasManyReceiversTx) Find() (result []*models.Receiver, err error) {
	return result, a.tx.Find(&result)
}

func (a woodSpecTypeHasManyReceiversTx) Append(values ...*models.Receiver) (err error) {
...
func (a woodSpecTypeHasManyReceiversTx) Replace(values ...*models.Receiver) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a woodSpecTypeHasManyReceiversTx) Delete(values ...*models.Receiver) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a woodSpecTypeHasManyReceiversTx) Clear() error {
	return a.tx.Clear()
}

func (a woodSpecTypeHasManyReceiversTx) Count() int64 {
	return a.tx.Count()
}
